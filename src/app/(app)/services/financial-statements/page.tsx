                ...
                <div className="w-full order-1 mx-auto lg:order-none">
                  ...
                  <div className="text-sm text-gray-500 lg:text-base">
                    <p className="mt-[15px] lg:mt-[26px]">
                      A large and modern accounting firm does not have to lose
                      its human touch. In fact, we are one of the biggest
                      accounting firms in india. While we concentrate on the
                      relationship between you as an entrepreneur and your
                      personal accounting consultant.
                    </p>
                    <p className="mt-[15px] lg:mt-[26px]">
                      Your accounting consultant also has a replacement in the
                      background. This person is kept up to date on your company
                      and can quickly step in if your consultant gets sick or
                      for any other reason.
                    </p>
                    <p className="mt-[15px] lg:mt-[26px]">
                      You get help with just those parts of the report that you
                      need. Together we will find a plan that works. And which
                      can be adapted as things change for you and your business.
                    </p>
                  </div>
                  ...
                  <div className="space-y-8 lg:space-y-16">
                    <div className="space-y-[15px] lg:space-y-[26px]">
                      ...
                      <p className="text-sm text-gray-500 lg:text-base">
                        You will receive a refund if, as a partner, we
                        don&apos;t live up to your expectations. For us, nothing
                        matters more than our clients&apos; satisfaction. We
                        have an average customer satisfaction rating of 9/10*,
                        therefore we are certain that you will be happy working
                        with us as your financial partner as well.. Should our
                        service not match your expectations, you may discontinue
                        the partnership with us within the first 60 days from
                        signing the contract and get back the cost of the
                        ongoing accounting**.
                      </p>
                      <p className="text-sm text-gray-500 lg:text-base">
                        Average rating for the customer experience of our advice
                        in our ongoing customer survey.
                      </p>
                    </div>
                    ...
                    <div className="space-y-[15px] lg:space-y-[26px]">
                      ...
                      <p className="text-sm text-gray-500 lg:text-base">
                        Maybe you want to take care of payroll and invoicing on
                        your own, but need a little more help with bookkeeping
                        and financial statements. You can choose to work with us
                        whether you need a full-service accounting firm that
                        covers the whole accounting process, or you just need a
                        one-stop shop for individual accounting support and
                        guidance. We always cater to your needs and
                        circumstances.
                      </p>
                    </div>
                  ...
                  <ServicesFooter href="/services/bookkeeping" service="Bookkeeping Services" text="We are here to address any questions you may have as you implement your plan. Additionally, for clients seeking an ongoing partnership, we provide comprehensive" />
                </div>
              </div>
            </div>
          </section>
